...
if ($formulaire_soumis) {
    ...
    if ($majAuteurCommande->rowCount()>0){
        $editsuccess="La mise à jour a bien été effectué."; 
        
    }else {
        $editfail="Il y a une erreur avec la modification.";
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6">
            <?php if (isset($editsuccess)) { 
                echo "<section class='rounded-lg bg-green-500 p-2 border-1 text-center'> $editsuccess </section>";
            }else if(isset($editfail)){ 
                echo "<section class='rounded-lg bg-red-500 p-2 border-1 text-center'> $editfail </section>"; 
            } ?>
