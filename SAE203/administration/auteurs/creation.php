...
if ($formulaire_soumis) {
    if (
        ...
        if ($creerAuteurCommande->rowcount()>0){
            $creasuccess = $nom."  ".$prenom. " a bien été crée.";

        }else{
            $creafail = "Il y a une erreur avec la création de l'auteur.";
...
<body>
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
           ...
           if(isset($creasuccess) && !empty($creasuccess)) {
            ?>
                <section class="rounded-lg bg-green-500 p-2 border-1 text-center">
                    <?php echo $creasuccess; ?>
                </section>
            <?php
           }else if(isset($creafail) && !empty($creafail)){
            echo "<section class='rounded-lg bg-red-500 p-2 border-1 text-center'> $creafail </section>"; 
           }
                ...
                <form method="POST" action="" class="rounded-lg bg-white p-4 shadow border-gray-300 border-1">
                    <section class="grid gap-6">
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="text" name="lien_avatar" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" id="avatar" required>
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="url" name="lien_twitter" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" id="lien_twitter" required>
                        </div>
